...
# When i changes the value of max_depth to None,1 and 3 the accuracy gives 100 %. It means the dataset is simple and clearly seperable.
# So simple model can achieve 100 % accuracy.